...
use App\Models\Catalogos\CtgProveedores;

class ProvedoresCtg extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.catalogos.provedores-ctg', compact('proveedores'));
