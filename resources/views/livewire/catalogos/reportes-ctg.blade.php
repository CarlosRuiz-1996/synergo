    ...
    <x-dialog-modal-xl wire:model.live="open" id="">
        ...
        @slot('content')
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    <x-label-modal>Titulo</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="titulo" />
                ...
                <div>
                    <x-label-modal>Nivel</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="nivel" />

                        <x-input-error for="nivel" />
                </div>
