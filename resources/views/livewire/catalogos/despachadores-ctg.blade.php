                            ...
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th scope="col"
                                        ...
                                        cursor-pointer"
                                        wire:click="order('nip')">
                                        <p>Nip
                                            @if ($sort_despachador == 'nip')
                                                @if ($orderBy == 'asc')
                                                    <i class="fas fa-sort-alpha-up-alt mt-1"></i>
                                                @else
                                                    <i class="fas fa-sort-alpha-down-alt mt-1"></i>
                                    ...
                                    <th scope="col"
                                        ...
                                        Descripción
                                        @if ($sort_despachador == 'descripcion')
                                            @if ($orderBy == 'asc')
                                                <i class="fas fa-sort-alpha-up-alt mt-1"></i>
                                            @else
                                                <i class="fas fa-sort-alpha-down-alt mt-1"></i>
                                    ...
                                    <th scope="col"
                                        class="px-3 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider
                                        cursor-pointer"
                                        wire:click="order('turno')">
                                        Turno
                                        @if ($sort_despachador == 'turno')
                                            @if ($orderBy == 'asc')
                                                <i class="fas fa-sort-alpha-up-alt mt-1"></i>
                                            @else
                                                <i class="fas fa-sort-alpha-down-alt mt-1"></i>
                                    ...
                                    <th scope="col"
                                        class="px-3 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider
                                        cursor-pointer"
                                        wire:click="order('llavero')">
                                        Llavero
                                        @if ($sort_despachador == 'llavero')
                                            @if ($orderBy == 'asc')
                                                <i class="fas fa-sort-alpha-up-alt mt-1"></i>
                                            @else
                                                <i class="fas fa-sort-alpha-down-alt mt-1"></i>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                                            ...
                                            <x-danger-button title="Eliminar"
                                                wire:click="$dispatch('delete-despachadores',{{ $catalogo->id }})"><i
    ...
    <x-dialog-modal-xl wire:model.live="open" id="">
        ...
        @slot('content')
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    <x-label-modal>Nip</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="nip" />
                ...
                <div>
                    <x-label-modal>Turno</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="turno" />

                        <x-input-error for="turno" />
                </div>
                <div>
                    <x-label-modal>Llavero</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="llavero" />

                        <x-input-error for="llavero" />
                </div>
        ...
        @slot('footer')
            ...
            <x-button wire:click="$dispatch('confirm-despachadores',{{ $ctg_id }}) "
