    ...
    <x-dialog-modal-xl wire:model.live="open" id="">
        ...
        @slot('content')
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    <x-label-modal>No Gasto</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="no_gasto" />

                        <x-input-error for="no_gasto" />
                </div>
                <div>
                    <x-label-modal>Concepto</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="concepto" />

                        <x-input-error for="concepto" />
                </div>
                <div>
                    <x-label-modal>Tipo Gasto</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="tipo_gasto" />

                        <x-input-error for="tipo_gasto" />
                </div>
                <div>
                    <x-label-modal>Relación</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="relacion" />

                        <x-input-error for="relacion" />
                </div>
