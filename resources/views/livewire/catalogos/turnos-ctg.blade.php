<div>
                            ...
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th scope="col"
                                        ...
                                        wire:click="order('inicio')">
                                        <div class="flex items-center">
                                            <span>Inicio</span>
                                            @if ($sort_turno == 'inicio')
                                                @if ($orderBy == 'asc')
                                    ...
                                    <th scope="col"
                                        class="px-3 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider
                                        cursor-pointer"
                                        wire:click="order('duracion')">
                                        Duración
                                        @if ($sort_turno == 'duracion')
                                            @if ($orderBy == 'asc')
                                                <i class="fas fa-sort-alpha-up-alt mt-1"></i>
                                            @else
                                                <i class="fas fa-sort-alpha-down-alt mt-1"></i>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                                            ...
                                            <x-danger-button title="Eliminar"
                                                wire:click="$dispatch('delete-turnos',{{ $catalogo->id }})"><i
    ...
    <x-dialog-modal-xl wire:model.live="open" id="">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    <x-label-modal>descripcion</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="descripcion" />

                        <x-input-error for="descripcion" />
                </div>
                <div>
                    <x-label-modal>inicio</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="inicio" />

                        <x-input-error for="inicio" />
                </div>
                <div>
                    <x-label-modal>Duración</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="duracion" />
        ...
        @slot('footer')
            ...
            <x-button wire:click="$dispatch('confirm-turnos',{{ $ctg_id }}) "
