    ...
    <x-dialog-modal-xl wire:model.live="open" id="">
        ...
        @slot('content')
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    <x-label-modal>No secuencial</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="no_secuencial" />

                        <x-input-error for="corta" />
                </div>
                <div>
                    <x-label-modal>Saldo</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="saldo" />

                        <x-input-error for="saldo" />
                </div>
                <div>
                    <x-label-modal>Imprimir</x-label>
                        <x-input-modal type="text" class="w-full" wire:model="imprimir" />

                        <x-input-error for="imprimir" />
                </div>
